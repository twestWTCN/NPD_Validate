function [] = mvarconsim_npdver(C,NCV,frstord,sndord,fname)
...
%             [f1z2,t1z2] = HOpartcohtw_160517(x',y',z2',250,8,0);
    ...
    if ncov==NC
        ...
        annotation(gcf,'textbox',...
            [0.351 0.941 0.321 0.043],...
            'String',{['NonParametric Directionality Partialed on ' num2str(frstord) ' : Spectra']},...
            'HorizontalAlignment','center',...
            'FitBoxToText','off',...
            'EdgeColor','none');
    end
    ...
    if ncov==NC
        ...
        annotation(gcf,'textbox',...
            [0.351 0.941 0.321 0.043],...
            'String',{['2nd Order Partialised Coherence conditioned on ' num2str(sndord(1)) ' and ' num2str(sndord(2))]},...
            'HorizontalAlignment','center',...
            'FitBoxToText','off',...
            'EdgeColor','none');
    end
end
saveallfiguresFIL(['C:\Users\twest\Documents\Work\PhD\NPD_Validate\MVAR_model\figures\' fname '\outputs_ ' fname],'-jpg')