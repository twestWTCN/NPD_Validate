function [Hz lags npdspctrm npdspctrmZ npdspctrmW nscohspctrm npdcrcv npdcrcvZ npdcrcvW] = ft_computeNPD(freq,fsamp,frstord,npdord,bstrap,bstraptype)
if nargin<3
    npdord = 8;
end
if nargin<4
...
%             end
    ...
    dw = squeeze(freq.fourierspctrm(:,frstord+1,:));
        ...
        [f13 t13 f13Z t13Z f13W t13W ci13 ci13Z ci13W] = ft_NPD_XYZW(dx,dy,dz,dw,fsamp,npdord,bstrap,bstraptype);
