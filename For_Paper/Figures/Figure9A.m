...
for dataLen = 1:size(NCvec,2)
    ...
    save(['C:\Users\Tim\Documents\Work\GIT\NPD_Validate\benchmark\simdata_9A_' num2str(dataLen)],'data')
end

% Now test for recovery with dFC metrics
for dataLen = 1:size(NCvec,2)
    load(['C:\Users\Tim\Documents\Work\GIT\NPD_Validate\benchmark\simdata_9A_' num2str(dataLen)],'data')
    bstrap = 1;
    for i = 1:ncons
        for n = 1:nreps
            TrueCMat = CMat{i,n};
...
save('C:\Users\Tim\Documents\Work\GIT\NPD_Validate\benchmark\9ABenchMarks','NPGScore','NPGScore','NCvec','DA')

load('C:\Users\Tim\Documents\Work\GIT\NPD_Validate\benchmark\9ABenchMarks','NPGScore','NPGScore','NCvec','DA')
subplot(1,2,2)
